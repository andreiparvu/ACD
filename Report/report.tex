...
A survey by \cite{King:04} shows that the approach by Whaley and Rinard is more precise
than the algorithm by Choi et all, they are able to stack allocate more objects and
remove more synchronization.


\textcolor{gray}{ Next, you have to give a brief overview of
