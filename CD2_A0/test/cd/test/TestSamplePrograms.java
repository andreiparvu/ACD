...
public class TestSamplePrograms extends AbstractTestSamplePrograms {
	 ...
	 */
//	public static final File justFile = new File("javali_tests/A1/HelloWorld.javali");
	public static final File justFile = new File("javali_tests/A0/while_return.java");
