...
public abstract class Ast {
	...
	protected static abstract class LeftRightExpr extends Expr {
	...
	protected static abstract class ArgExpr extends Expr {
	...
	public static class Free extends Stmt {
		public Free(Expr arg) {
			super(1);
			assert arg != null;
			setArg(arg);
		}
	...
	public static class BuiltInReadFloat extends LeafExpr {
	...
	public static class BuiltInWriteFloat extends Stmt {
	...
	public static class MethodCall extends Stmt {
		...
		@Override
		public Ast deepCopy() {
			return new MethodCall((Expr) receiver().deepCopy(), methodName, deepCopyArguments());
		}
